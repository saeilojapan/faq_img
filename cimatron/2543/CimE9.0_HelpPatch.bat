...
<head>
        ...
        <link href="/faq/Css/Custom?v=wvvmtkdohmzdgmxewsano4ag&amp;dispNodeId=0" rel="stylesheet" type="text/css" />
...
<form action="/faq/Login/Index?dispNodeId=0" method="post"><input name="__RequestVerificationToken" type="hidden" value="a0WWJnrQ-VBppEDQy2ORJUaI6h1Q9s0z9D5Ybsauie2TspUVSDeHvTulR-OdLmW02WPwCG3OHbQjUZT6vkHIFIzX_aEg3SsxPQBy-HBagp-Q5bclmtqxkvPX3kjFbq4BxN1GJyTCzCcyMV_UgPvIC6sMEhHGsvQ4WZpviCy9u9g1" />    <div id="loginframe">
        <p style="border:0; margin: 0px 0px 7px 0px;">
            <img src="/faq/Temp/Pc/Logo/tempLogo.gif"
                alt="セイロジャパンサポートセンター" class="top-logo" />
        </p>
            <input name="__RequestVerificationToken" type="hidden" value="8O0iGYeb62EU_Cti5b67FjqozVXSk454QRfJwReJ1BZKEPr3wU2BLKtfSwYJoHHHMgD5GtA6fwIRc5ZPxPiuW1_PoTUjwHRlncn9J-ygt7-RrWF-AowomL9GfsJ-KL2-2jaBpor1pqwvs7rigIfgwnq5EO4X_iDF6wu-ezGBv_c1" />
	...
	NCSIMUL：<A href="mailto:ncs-support@saeilo.co.jp">ncs-support@saeilo.co.jp</A><br>
        ...
        <input id="ReturnParameters" name="ReturnParameters" type="hidden" value="fileName=CimE9.0_HelpPatch.bat&amp;fileName=CimE9.0_HelpPatch.bat" />
    </div>
    <!--  footer part Start -->
