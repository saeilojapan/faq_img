...
<head>
        ...
        <link href="/faq/Css/Custom?v=pdpy4tselfnrs23qvrjcnlde&amp;dispNodeId=0" rel="stylesheet" type="text/css" />
...
<form action="/faq/Login/Index?dispNodeId=0" method="post"><input name="__RequestVerificationToken" type="hidden" value="fbiYBaVG38Y43XJOn-LQcm9Qk8CgMncBBJWNbDWEiZY3eP8H9mdZU3-Ke-tCLT0QERocgRUGiFPk69NlmOukWaPuYFm6oshU_4YcuUM1cge7RjmYvdylApjeHdE-ICa8zIwWkiTLHaxG2zc7uVi08pokVLfEIyfOFrs66pcuNxU1" />    <div id="loginframe">
        <p style="border:0; margin: 0px 0px 7px 0px;">
            <img src="/faq/Temp/Pc/Logo/tempLogo.gif"
                alt="セイロジャパンサポートセンター" class="top-logo" />
        </p>
            <input name="__RequestVerificationToken" type="hidden" value="JieNT9j0mP-fBtD6woNDwEywUigXt9t3A2DuvnsD2X3smeBsHYtCW_IunFNvx2UU134gngJb-AkjE3MBTbLemuX52BpA1IZU74FSdDvrjr7n6FlC1QDW3t1iDmuhWpAmkU4RBQCKCKYG6qWQEdvnnzvbrw1ywm2ZtKzREfET9jk1" />
	...
	NCSIMUL：<A href="mailto:ncs-support@saeilo.co.jp">ncs-support@saeilo.co.jp</A><br>
        ...
        <input id="ReturnParameters" name="ReturnParameters" type="hidden" value="fileName=CimE9SP2P1.bat&amp;fileName=CimE9SP2P1.bat" />
    </div>
    <!--  footer part Start -->
